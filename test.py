...
class Ollama:
    ...
    def __init__(self, base_url: str, model: str, system: str):
        '''
...
if __name__ == "__main__":
    ollama = Ollama(
        ...
        model='mistral:7b',
        system='your name is gizmo, report as gizmo, refer to yourself as gizmo'
    )

    print("Talk to Gizmo! Type 'exit' to quit.\n")
    ...
    while True:
        ...
        if user_input.lower() in {"exit", "quit"}:
            print("Gizmo: Goodbye!")
            break
        response = ollama.generateWithMemory(user_input)
        print("\n")  # Optional: Just for cleaner spacing between Q&A
